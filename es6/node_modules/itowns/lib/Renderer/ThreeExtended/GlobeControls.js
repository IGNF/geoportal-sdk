...
function GlobeControls(view, target, radius) {
    ...
    var onMouseMove = function () {
        ...
        return function (event) {
            ...
            var coords = this._view.eventToViewCoords(event);
            var x = coords.x;
            var y = coords.y;
    ...
    var onMouseDown = function (event) {
        ...
        player.stop().then(function () {
            ...
            var coords = _this2._view.eventToViewCoords(event);
            var x = coords.x;
            var y = coords.y;
    ...
    this.domElement.addEventListener('dblclick', function (event) {
        ...
        if (!currentKey) {
            var point = view.getPickingPositionFromDepth(this._view.eventToViewCoords(event));
