...
function drawFeature(ctx, feature, origin, dimension, extent) {
    ...
    var vertices = feature.geometry.vertices.slice();
...
function drawFeatureCollection(ctx, collection, origin, dimension, extent) {
    ...
    try {
        for (var _iterator2 = (0, _getIterator3.default)(collection.children), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            if (features.extent.intersect(extent)) {
                for (var id in features.featureVertices) {
                    ...
                    var vertices = features.vertices.slice(polygon.offset, polygon.offset + polygon.count);
