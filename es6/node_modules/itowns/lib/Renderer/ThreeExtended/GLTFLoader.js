...
exports.default = function () {
  ...
  */
	...
	function isPrimitiveEqual(a, b) {
		...
		var keysA = (0, _keys2.default)(attribA);
		var keysB = (0, _keys2.default)(attribB);
  ...
  */
	GLTFParser.prototype.getDependencies = function (type) {
		...
		if (!dependencies) {
			...
			dependencies = _promise2.default.all(defs.map(function (def, index) {
  ...
  */
	GLTFParser.prototype.getMultiDependencies = function (types) {
		...
		return _promise2.default.all(pendings).then(function () {
  ...
  */
	GLTFParser.prototype.loadBuffer = function (bufferIndex) {
		...
		if (bufferDef.uri === undefined && bufferIndex === 0) {
			...
			return _promise2.default.resolve(this.extensions[EXTENSIONS.KHR_BINARY_GLTF].body);
		}
  ...
  */
	GLTFParser.prototype.loadAccessor = function (accessorIndex) {
		...
		return _promise2.default.all(pendingBufferViews).then(function (bufferViews) {
  ...
  */
	GLTFParser.prototype.loadTexture = function (textureIndex) {
		...
		return _promise2.default.resolve(sourceURI).then(function (sourceURI) {
  ...
  */
	GLTFParser.prototype.loadMaterial = function (materialIndex) {
		...
		return _promise2.default.all(pending).then(function () {
  ...
  */
	GLTFParser.prototype.loadCamera = function (cameraIndex) {
		...
		return _promise2.default.resolve(camera);
	};
  ...
  */
	GLTFParser.prototype.loadSkin = function (skinIndex) {
		...
		if (skinDef.inverseBindMatrices === undefined) {
			...
			return _promise2.default.resolve(skinEntry);
		}
				...
				if (sampler) {
					...
					if (node) {
						...
						for (var j = 0, jl = targetNames.length; j < jl; j++) {
							...
							tracks.push(new TypedKeyframeTrack(targetNames[j] + '.' + PATH_PROPERTIES[target.path], THREE.AnimationUtils.arraySlice(inputAccessor.array, 0), THREE.AnimationUtils.arraySlice(outputAccessor.array, 0), interpolation));
						}
					}
				}
			}
