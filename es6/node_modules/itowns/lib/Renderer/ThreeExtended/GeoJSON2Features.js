...
var coords = new _Coordinates2.default('EPSG:4978', 0, 0, 0);
function readCoordinates(crsIn, crsOut, coordinates, extent) {
    ...
    try {
        for (var _iterator = (0, _getIterator3.default)(coordinates), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (crsIn === crsOut) {
                out[i] = new _Coordinates2.default(crsIn, pair[0], pair[1], 1);
            } else {
...
var GeometryToCoordinates = {
        ...
        try {
            for (var _iterator2 = (0, _getIterator3.default)(geoms), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                if (!result) {
                    ...
                    try {
                        for (var _iterator3 = (0, _getIterator3.default)(geom.coordinates), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    multiPolygon: function multiPolygon(crsIn, crsOut, coordsIn, filteringExtent, options) {
        ...
        try {
            for (var _iterator5 = (0, _getIterator3.default)(coordsIn), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
function readFeature(crsIn, crsOut, json, filteringExtent, options) {
    ...
    try {
        for (var _iterator6 = (0, _getIterator3.default)((0, _keys2.default)(json)), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
function readFeatureCollection(crsIn, crsOut, json, filteringExtent, options) {
    ...
    try {
        for (var _iterator7 = (0, _getIterator3.default)(json.features), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
