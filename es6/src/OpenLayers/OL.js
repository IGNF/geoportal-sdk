...
OL.prototype.addGraphicScaleControl = function (controlOpts) {
    ...
    this.logger.trace("[OL] addGraphicScaleControl : setting graphicscale units to " + ol3units);
 ...
 * @private
 */
OL.prototype._getCommonLayerParams = function (ol3layerOpts) {
    var commonOpts = {};
    this.logger.trace("[OL] : _getCommonLayerParams ");
    if (ol3layerOpts.hasOwnProperty("opacity")) {
        this.logger.trace("[OL] : _getCommonLayerParams - opacity : " + ol3layerOpts.opacity);
        commonOpts.opacity = ol3layerOpts.opacity;
    }
    if (ol3layerOpts.hasOwnProperty("visible")) {
        this.logger.trace("[OL] : _getCommonLayerParams - visibility : " + ol3layerOpts.visible);
        commonOpts.visibility = ol3layerOpts.visible;
    }
    if (ol3layerOpts.hasOwnProperty("zIndex")) {
        this.logger.trace("[OL] : _getCommonLayerParams - position : " + ol3layerOpts.zIndex);
                    ...
                    if (obsProperty === "grayScaled") {
                        ...
                        olEventKey = olLayer.on(
                            ...
                            function (ol3evt) {
                                ...
                                action.call(context, {
                                    property : OL.LAYERPROPERTIES[ol3evt.key],
                                    oldValue : oldCommonProp[OL.LAYERPROPERTIES[ol3evt.key]],
                                    newValue : newCommonProp[OL.LAYERPROPERTIES[ol3evt.key]],
                                    layerChanged : layerOpts
                                });
                            },
                            olLayer
